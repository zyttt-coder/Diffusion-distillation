...
from pipeline_emb_ori import EmbPipeline, EmbModel
...
class EmbDataset(Dataset):
    def __init__(self, dataset_name, data_dir, 
        ...
        if dataset_name == 'imagenet':
            ...
            num_classes=10
            cls_list = [84, 130, 88, 144, 145, 22, 96, 9, 100, 89]
            class_map = {i: [] for i in cls_list}
            ...
            print({i: len(class_map[i]) for i in cls_list})
...
def main():
    ...
    args.data_dir = os.path.join(os.getcwd(),args.data_dir,"imagenet_train")
